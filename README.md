...
* need **GROQ_API_KEY** to be set in the enviorement as the client is called as-> Groq(api_key=os.environ.get("GROQ_API_KEY")) ,if not done the llm will not execute
---
2)Triggering python script
